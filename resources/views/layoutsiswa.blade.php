...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="/siswa">Home</a></li>
                <li class="nav-item"><a class="nav-link" href="/siswa/jadwal">Jadwal</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="/siswa/akun">Akun</a></li>
            </ul>
        </div>
    </div>
</nav>
